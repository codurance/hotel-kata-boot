...
class BasicBookingServiceTest {
    ...
    private LocalDateTime checkIn = LocalDateTime.parse("2020-01-01 10:00", DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm"));
    private LocalDateTime checkOut = LocalDateTime.parse("2020-01-10 10:00", DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm"));
    ...
    public void shouldPersistBooking() throws Exception{
        ...
        given(bookingRepositoryStub.findAvailableRooms(roomType, checkIn, checkOut)).willReturn(new ArrayList<>());
